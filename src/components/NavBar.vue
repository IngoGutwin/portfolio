<template>
    ...
    >
        ...
        >
            ...
            <IconsGitHub class="md:hidden m-4" />
            <IconsTwitteR class="md:hidden m-4" />
            <IconsLinkedIn class="md:hidden m-4" />
        </ul>
    </nav>
</template>
...
.navBar {
    ...
    &__box {
        @apply flex flex-col pt-36 px-8 gap-12 fixed top-0 right-0 w-6/12 bg-blue-zodiac-500/60 backdrop-blur-sm h-screen transition ease-linear translate-x-full;
